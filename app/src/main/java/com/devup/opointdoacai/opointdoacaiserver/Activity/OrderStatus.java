...
public class OrderStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Pedidos Solicitados");
    ...
    private void loadOrders() {
        ...
        Query search = requests.orderByChild("status").equalTo("0");
                                    ...
                                    .enqueue(new Callback<MyResponse>() {
                                        ...
                                        public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                            ...
                                            if (response.body().success == 1){
                                                ...
                                                Toasty.success(OrderStatus.this, " O Pedido foi atualizado", Toast.LENGTH_SHORT).show();

                                            }else{

                                                Toasty.info(OrderStatus.this, " O Pedido foi atualizado, mas a notificação falhou ao ser enviada ao cliente", Toast.LENGTH_SHORT).show();
