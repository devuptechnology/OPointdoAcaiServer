...
public class OrderStatus3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_status3);

        //Iniciando Serviços
        mService = Common.getFCMClient();

        //Toolbar - Instanciando
        toolbar = findViewById(R.id.toolbar_id_order_saiu);
        toolbar.setTitle("Pedidos Saiu para Entrega");
        ...
        //Init
        recyclerView = findViewById(R.id.listOrders3);
    ...
    private void loadOrders() {
        ...
        Query search = requests.orderByChild("status").equalTo("2");
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        if (!isLongClick){
                            ...
                            Intent orderDetailIntent = new Intent(OrderStatus3.this, OrderDetail.class);
    ...
    private void showUpdateDialog(String key, final Request item) {
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(OrderStatus3.this);
                                    ...
                                    .enqueue(new Callback<MyResponse>() {
                                        ...
                                        public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                            ...
                                            if (response.body().success == 1){
                                                ...
                                                Toasty.success(OrderStatus3.this, " O Pedido foi atualizado", Toast.LENGTH_SHORT).show();

                                            }else{

                                                Toasty.info(OrderStatus3.this, " O Pedido foi atualizado, mas a notificação falhou ao ser enviada ao cliente", Toast.LENGTH_SHORT).show();
