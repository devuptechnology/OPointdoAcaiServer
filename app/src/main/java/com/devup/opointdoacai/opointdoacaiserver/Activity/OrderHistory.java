...
public class OrderHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.toolbar_id_order_history);
        ...
        //Init
        recyclerView = findViewById(R.id.listOrdersHistory);
    ...
    private void loadOrders() {
        ...
        Query search = requests.orderByChild("status").equalTo("3");
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        if (!isLongClick){
                            ...
                            Intent orderDetailIntent = new Intent(OrderHistory.this, OrderDetail.class);
    ...
    private void showUpdateDialog(String key, final Request item) {
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(OrderHistory.this);
                                    ...
                                    .enqueue(new Callback<MyResponse>() {
                                        ...
                                        public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                            ...
                                            if (response.body().success == 1){
                                                ...
                                                Toasty.success(OrderHistory.this, " O Pedido foi atualizado", Toast.LENGTH_SHORT).show();

                                            }else{

                                                Toasty.info(OrderHistory.this, " O Pedido foi atualizado, mas a notificação falhou ao ser enviada ao cliente", Toast.LENGTH_SHORT).show();
